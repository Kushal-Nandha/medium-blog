...
return <form>
   <div className="w-full mb-4   rounded-lg bg-gray-50">
       ...
       <div className=" my-2 bg-white rounded-b-lg w-full ">
           ...
           <textarea onChange={onChange} id="editor" rows={8} className="focus:outline-none pl-3 pt-3 block w-full px-0 text-sm text-gray-800 bg-white border-0" placeholder="Write an article..." required />
       </div>
   </div>
   </div>
</form>
